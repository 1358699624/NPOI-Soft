...
namespace YY_Services
{
    ...
    public class NpoiExcelOperationService
    {
        ...
        public bool DataExportOutPage(List<UserInfo> ts,out string resultMsg, out string excelFilePath)
        {
            var result = true;
            excelFilePath = "";
            resultMsg = "successfully";
            ...
            try
            {
                ...
                string TempletFileName = "E:\\马连军\\Excel-Import\\YY_Npoi_ExportAndImport\\Template\\人员信息表.xlt";
                string ReportFileName = "E:\\马连军\\Excel-Import\\YY_Npoi_ExportAndImport\\Template\\人员信息表.xlt";    //导出文件  
                ...
                //sheet.DefaultColumnWidth = 30;//默认列宽
